// For POC: reset mockEmailData to its initial seed and reset metrics
const seed = [
...
mockEmailData.setValue(seed);
emailMetrics.setValue({ total: seed.length, processed: 0, pending: seed.length });
